# Copied from https://github.com/gitpod-io/workspace-images/blob/master/full/Dockerfile so I can edit GO_VERSION
...
RUN curl -fsSL https://golang.org/dl/go$GO_VERSION.linux-amd64.tar.gz | tar xzs
# user Go packages
...
RUN cp /home/gitpod/.profile /home/gitpod/.profile_orig && \
    curl -fsSL https://sh.rustup.rs | sh -s -- -y --profile minimal --default-toolchain 1.50.0 \
